...
class ControlloreStanze:
    ...
    def __init__(self, servizio_stanze: ServizioStanze) -> None:
        self._servizio_stanze = servizio_stanze

    def crea_stanza(self, nome: str, piano: int) -> Stanza:
